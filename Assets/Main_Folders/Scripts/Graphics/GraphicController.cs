...
namespace Main_Folders.Scripts.Graphics
{
    public class GraphicController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            _resolutionDropdown = GameObject.Find("Canvas/OptionsMenu/Container/FullScreen/Dropdown")
                .GetComponent<TMP_Dropdown>();
            GraphicManager.Instance.resolutionDropdown = _resolutionDropdown;
            _qualityDropdown = GameObject.Find("Canvas/OptionsMenu/Container/Graphics/GraphicsDropdown")
                .GetComponent<TMP_Dropdown>();
            GraphicManager.Instance.qualityDropdown = _qualityDropdown;
            _fullScreenToggle =
                GameObject.Find("Canvas/OptionsMenu/Container/FullScreen/Toggle").GetComponent<Toggle>();
