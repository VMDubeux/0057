...
public class EncounterSystem : MonoBehaviour
{
    ...
    //[SerializeField] private int minNumEnemies; // Se quiser, pode ser um n�mero fixo, basta modificar no GenerateEnemiesByEncounter.
    //[SerializeField] private int maxNumEnemies; // Se quiser, pode ser um n�mero fixo, basta modificar no GenerateEnemiesByEncounter.
